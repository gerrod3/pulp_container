...
class TestManifestCopy:
    ...
    def setup(
        ...
        self.from_repo = container_repository_factory()
        self.remote = container_remote_factory(upstream_name=PULP_FIXTURE_1)
        container_sync(self.from_repo, self.remote)
        self.from_repo = container_bindings.RepositoriesContainerApi.read(self.from_repo.pulp_href)
        self.latest_from_version = self.from_repo.latest_version_href
    ...
    @pytest.mark.parallel
    def test_source_repository_and_source_version(self, container_repo, container_bindings):
    ...
    @pytest.mark.parallel
    def test_copy_all_manifests(self, container_repo, container_bindings, monitor_task):
        ...
        copy_response = container_bindings.RepositoriesContainerApi.copy_manifests(
            container_repo.pulp_href, {"source_repository": self.from_repo.pulp_href}
        )
        monitor_task(copy_response.task)

        latest_to = container_bindings.RepositoriesContainerApi.read(container_repo.pulp_href)
        latest_from = container_bindings.RepositoriesContainerApi.read(self.from_repo.pulp_href)
    ...
    def test_copy_all_manifests_from_version(
        self, container_repo, container_bindings, monitor_task
    ):
        """Passing only source version copies all manifests."""
        latest_from = container_bindings.RepositoriesContainerApi.read(self.from_repo.pulp_href)
        copy_response = container_bindings.RepositoriesContainerApi.copy_manifests(
            container_repo.pulp_href, {"source_repository_version": latest_from.latest_version_href}
        )
        monitor_task(copy_response.task)
    ...
    @pytest.mark.parallel
    def test_copy_manifest_by_digest(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_fail_to_copy_invalid_manifest_media_type(self, container_repo, container_bindings):
        """Specify the media_type, to copy all manifest lists."""
        with pytest.raises(container_bindings.ApiException) as context:
            container_bindings.RepositoriesContainerApi.copy_manifests(
                container_repo.pulp_href,
    ...
    def test_copy_by_digest_with_incorrect_media_type(
        ...
        ml_i_href = (
            container_bindings.ContentTagsApi.list(
                name="ml_i", repository_version=self.latest_from_version
            )
            .results[0]
            .tagged_manifest
        )
    ...
    def test_copy_multiple_manifests_by_digest(
        ...
        ml_ii_href = (
            container_bindings.ContentTagsApi.list(
                name="ml_ii", repository_version=self.latest_from_version
            )
            .results[0]
            .tagged_manifest
        )
    ...
    @pytest.mark.parallel
    def test_copy_manifests_by_digest_empty_list(self, container_repo, container_bindings):
        """Passing an empty list copies no manifests."""
        container_bindings.RepositoriesContainerApi.copy_manifests(
            container_repo.pulp_href, {"source_repository": self.from_repo.pulp_href, "digests": []}
        )
        latest_to = container_bindings.RepositoriesContainerApi.read(container_repo.pulp_href)
...
class TestTagCopy:
    ...
    @pytest.mark.parallel
    def test_copy_all_tags(self, container_repo, container_bindings, monitor_task):
        ...
        to_repo = container_bindings.RepositoriesContainerApi.read(container_repo.pulp_href)
        from_repo = container_bindings.RepositoriesContainerApi.read(self.from_repo.pulp_href)
        to_repo_content = container_bindings.RepositoriesContainerVersionsApi.read(
            to_repo.latest_version_href
        ).content_summary.present
        from_repo_content = container_bindings.RepositoriesContainerVersionsApi.read(
    ...
    @pytest.mark.parallel
    def test_copy_all_tags_from_version(self, container_repo, container_bindings, monitor_task):
        """Passing only source version and destination repositories copies all tags."""
        latest_from_repo_href = container_bindings.RepositoriesContainerApi.read(
    ...
    @pytest.mark.parallel
    def test_copy_tags_by_name(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_copy_tags_by_name_empty_list(self, container_repo, container_bindings, monitor_task):
        """Passing an empty list of names copies nothing."""
        copy_response = container_bindings.RepositoriesContainerApi.copy_tags(
            container_repo.pulp_href, {"source_repository": self.from_repo.pulp_href, "names": []}
        )
        monitor_task(copy_response.task)
...
class TestRecursiveAdd:
    ...
    @pytest.mark.parallel
    def test_manifest_recursion(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_manifest_list_recursion(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_tagged_manifest_list_recursion(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_tagged_manifest_recursion(self, container_repo, container_bindings, monitor_task):
    ...
    @pytest.mark.parallel
    def test_tag_replacement(self, container_repo, container_bindings, monitor_task):
        ...
        manifest_b = (
            container_bindings.ContentTagsApi.list(
                name="manifest_b", repository_version=self.latest_from_version
            )
            .results[0]
            .tagged_manifest
        )
    ...
    @pytest.mark.parallel
    def test_many_tagged_manifest_lists(self, container_repo, container_bindings, monitor_task):
        ...
        ml_iii_tag = (
            container_bindings.ContentTagsApi.list(
                name="ml_iii", repository_version=self.latest_from_version
            )
            .results[0]
            .pulp_href
        )
        ml_iv_tag = (
            container_bindings.ContentTagsApi.list(
                name="ml_iv", repository_version=self.latest_from_version
            )
            .results[0]
            .pulp_href
        )
